...
echo ("Che lor $verbo"."en<br> \n ");
echo "<b> <br> \n  Passaa <br> \n  </b>";
echo("<!-- Dedicaa a 'na persona ");
echo("che soo mi... Te voeuri ben -->");
echo ("Che mi $verbo"."essi <br> \n ");
echo ("Che ti te $verbo"."essett<br> \n ");
echo ("Che lu el $verbo"."ess<br> \n ");
echo ("Che num $verbo"."essom<br> \n ");
echo ("Che vialter $verbo"."essov<br> \n ");
echo ("Che lor $verbo"."essen<br> \n ");
echo "<b>  <br> \n  CONDIZIONAL <br> \n  </b>";
echo "<b> Present <br> \n  </b>";
echo ("Mi $verbo"."aria <br> \n ");
echo ("Ti te $verbo"."ariet<br> \n ");
